...
public class StickColour {
    ...
    public void setColour1FromString(String toParse)
    {
        if(toParse.length() != 9)
            return;
        this.red1 = Integer.valueOf(toParse.substring(0, 3));
        this.green1 = Integer.valueOf(toParse.substring(3, 6));
        this.blue1 = Integer.valueOf(toParse.substring(6, 9));
    }
    ...
    public void setColour2FromString(String toParse)
    {
        if(toParse.length() != 9)
            return;
        this.red2 = Integer.valueOf(toParse.substring(0, 3));
        this.green2 = Integer.valueOf(toParse.substring(3, 6));
        this.blue2 = Integer.valueOf(toParse.substring(6, 9));
    }
