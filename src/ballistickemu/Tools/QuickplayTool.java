...
public class QuickplayTool {
 ...
 public static Boolean PopulateNameList()
    {
     FirstNames = new LinkedHashMap<Integer, String>();
     LastNames = new LinkedHashMap<Integer, String>();
        try
        {
    ...
    {
        LinkedHashMap<Integer, StickItem> Inventory = new LinkedHashMap<Integer, StickItem>();
