...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Welcome to BallistickEMU.");
        ...
        Main.PORT = Integer.valueOf(ConfigProps.getProperty("server_Port"));
        Main.maxPlayers = Integer.valueOf(ConfigProps.getProperty("server_maxPlayers"));
